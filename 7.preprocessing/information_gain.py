...
def information_gain(databases, main_columns, feature_names):
    ...
    # feature_names = ["cbo", "wmc", "dit", "rfc", "lcom", "totalMethodsQty", "staticMethodsQty", "publicMethodsQty",
    #                  "privateMethodsQty", "protectedMethodsQty", "defaultMethodsQty", "abstractMethodsQty",
    #                  "finalMethodsQty", "synchronizedMethodsQty", "totalFieldsQty", "staticFieldsQty", "publicFieldsQty",
    #                  "privateFieldsQty", "protectedFieldsQty", "defaultFieldsQty", "visibleFieldsQty", "finalFieldsQty",
    ...
    #                  "maxNestedBlocksQty", "anonymousClassesQty", "innerClassesQty", "lambdasQty", "uniqueWordsQty",
    #                  "modifiers", "logStatementsQty",
    #                  "AvgLine", "AvgLineBlank", "AvgLineCode", "AvgLineComment", "AvgCyclomatic", "AvgCyclomaticModified",
    #                  "AvgCyclomaticStrict", "MaxCyclomatic", "MaxCyclomaticModified", "MaxCyclomaticStrict", "MaxEssential",
    ...
    #                  "BOC", "TACH", "FCH", "LCH", "CHO", "FRCH", "CHD", "WCD", "WFR", "ATAF", "LCA", "LCD", "CSB", "CSBS",
    #                  "ACDF",
    #                  "FANIN", "FANOUT", "TotalClassMethod", "DiversityTotal"]
    #
    # main_columns = ["project", "commit", "class",
    #                 "cbo", "wmc", "dit", "rfc", "lcom", "tcc", "lcc", "totalMethodsQty", "staticMethodsQty",
    ...
    #                 "publicFieldsQty", "privateFieldsQty", "protectedFieldsQty", "defaultFieldsQty", "visibleFieldsQty",
    #                 "finalFieldsQty", "nosi", "loc", "returnQty", "loopQty", "comparisonsQty", "tryCatchQty",
    #                 "parenthesizedExpsQty", "stringLiteralsQty", "numbersQty", "assignmentsQty", "mathOperationsQty",
    #                 "variablesQty", "maxNestedBlocksQty", "anonymousClassesQty", "innerClassesQty", "lambdasQty",
    #                 "uniqueWordsQty", "modifiers", "logStatementsQty",
    #                 "AvgLine", "AvgLineBlank", "AvgLineCode", "AvgLineComment", "AvgCyclomatic", "AvgCyclomaticModified",
    #                 "AvgCyclomaticStrict", "Cyclomatic", "CyclomaticModified", "CyclomaticStrict", "Essential",
    #                 "MaxCyclomatic", "MaxCyclomaticModified", "MaxCyclomaticStrict", "MaxEssential", "MaxInheritanceTree",
    #                 "MaxNesting", "PercentLackOfCohesion", "RatioCommentToCode", "SumCyclomatic", "SumCyclomaticModified",
    #                 "SumCyclomaticStrict", "SumEssential",
    #                 "BOC", "TACH", "FCH", "LCH", "CHO", "FRCH", "CHD", "WCD", "WFR", "ATAF", "LCA", "LCD", "CSB", "CSBS",
    #                 "ACDF",
    #                 "FANIN", "FANOUT", "LazyClass", "DataClass", "ComplexClass", "SpaghettiCode", "SpeculativeGenerality",
    #                 "GodClass", "RefusedBequest", "ClassDataShouldBePrivate", "BrainClass", "TotalClass",
    #                 "LongParameterList", "LongMethod", "FeatureEnvy", "DispersedCoupling", "MessageChain",
    #                 "IntensiveCoupling", "ShotgunSurgery", "BrainMethod", "TotalMethod", "TotalClassMethod",
