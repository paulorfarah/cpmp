...
from sklearn.metrics import ConfusionMatrixDisplay, confusion_matrix, multilabel_confusion_matrix, \
    precision_recall_curve, PrecisionRecallDisplay, average_precision_score, roc_auc_score
...
def multilabel_results(y_test, y_pred):
...
def create_model(c, parameters, kf, Xtrain, Xtest, Ytrain, Ytest,  algorithm ):
    ...
    multilabel_results(Ytest, best_model.predict(Xtest))
